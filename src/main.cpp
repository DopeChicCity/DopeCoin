...
uint256 hashGenesisBlock("0x7b5bede8e0dccd078ff9aeac097b80631fa7f2d4e5ff8c31d9c93071fb61c32b");
...
static const int64 nTargetTimespan = 2 * 60 * 60; // Dopecoin: 2 hours
static const int64 nTargetTimespanNEW = 60 ; // Dopecoin: every 1 minute
static const int64 nTargetSpacing = 1 * 60; // Dopecoin: 1 Minute Blocks
...
{
    // Dopecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x34ef163f721ab2e10905f6b109302ab942a6394505082001aa3135962427d56a");
    }
...
/*
2014-02-12 16:47:49 block.nTime = 1386680557
2014-02-12 16:47:49 block.nNonce = 752929181
2014-02-12 16:47:49 block.GetHash = 79682aadc6f31ee725521717e9a38840f20165b428e14543cf4de4978f8562da
*/
        // Genesis block
        const char* pszTimestamp = "Dope is on the market again";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1386680557;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 753335476;


        if (fTestNet)
        {
            block.nTime    = 1392222568;
            block.nNonce   = 387429524;
        }
...
unsigned char pchMessageStart[4] = { 0xda, 0xca, 0xda, 0xaa };
